...
#define TAM_NOME 50 // definindo a quantidade de caracteres que cada nome terá
#define NUM_ALUNOS 13 //definindo a quantodade de nomes que podem ser cadastrados

typedef enum{false, true} bool; // typedef pode declarar uma variavel "apelido", tipo como strcut de nomes longos,
